...
AquisitionBFS::AquisitionBFS(QObject *parent) : QObject(parent)
{
...
int AquisitionBFS::RunSingleCamera(CameraPtr pCam)
{
    int result;
...
int AquisitionBFS::PrintDeviceInfo(INodeMap& nodeMap)
{
...
int AquisitionBFS::AcquireImages(CameraPtr pCam, INodeMap& nodeMap, INodeMap& nodeMapTLDevice)
{
    int result = 0;
...
int AquisitionBFS::DisableHeartbeat(INodeMap& nodeMap, INodeMap& nodeMapTLDevice)
{
